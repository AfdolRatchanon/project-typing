...
import { keyboardRows, keyDisplays, keyToFingerMap, fingerZoneColors } from '../../data/keyboardData';
...
const VirtualKeyboard: React.FC<VirtualKeyboardProps> = ({
    ...
    return (
        <div data-testid="virtual-keyboard" className="flex-1 p-3 lg:p-4 bg-gray-100 rounded-lg shadow-inner border border-gray-200 overflow-x-auto">
