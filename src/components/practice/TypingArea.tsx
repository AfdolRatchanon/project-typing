  ...
  const textElements = textToType.split('').map((char, index) => {
    ...
    return (
      <span
        ...
        className={`
          ${colorClass}
          ${index === typedText.length ? 'border-b-2 animate-pulse' : ''}
...
const TypingArea: React.FC<TypingAreaProps> = ({
  ...
  return (
    <>
      ...
      <div className="p-2 lg:p-4 rounded-lg mb-3 lg:mb-4 min-h-[60px] lg:min-h-[70px] flex items-center justify-center text-base md:text-lg lg:text-xl leading-relaxed text-center font-mono relative overflow-hidden whitespace-pre-wrap niramit-regular"
